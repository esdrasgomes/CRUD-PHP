...
<html lang="pt-br">
	...
	?>
		...
		<div class="container" style="margin-top: 10px; text-align:center;">
			...
			<form action="atualizar_categoria.php" method="POST" style="margin-top: 10px">
				<?php
				...
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" name="nomecategoria" value="<?php echo $nomecategoria ?>" autocomplete="off">
				 ...
				 <a href="listar_categoria.php" role="button" class="btn btn-info btn-sm" style="font-weight: bold;">Voltar</a>
