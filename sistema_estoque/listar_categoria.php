...
<html>
	...
	?>
		...
		<div class="container" style="margin-top: 10px; text-align:center;">
			<h2>Categorias Cadastradas</h2><hr>
			<div class="row" style="">
			...
			<caption>Categorias Atuais</caption>
			  	<thead style="background-color: #16222A; color: #ffffff;">
			    	...
			    	<tr>
				      	...
				      	<td><a class="btn btn-success btn-sm" href="editar_categoria.php?id=<?php echo $id_categoria ?>" role="button"><i class="far fa-edit"></i>&nbsp;Editar</a>

				      		<a class="btn btn-danger btn-sm" href="excluir_categoria.php?id=<?php echo $id_categoria ?>" role="button"><i class="fas fa-trash-alt"></i></i>&nbsp;Excluir</a>
				      	</td>
