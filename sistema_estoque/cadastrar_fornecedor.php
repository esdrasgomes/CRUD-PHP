...
<html>
	...
	?>
		...
		<div class="container" id="tamanhoContainer" style="margin-top: 40px;">
			...
			<h4 style="text-align: center;">Cadastrar Fornecedor</h4><hr>

			<form action="inserir_fornecedor.php" method="post" style="margin-top: 30px">
				 <div class="form-group">
				    <label>Nome do Fornecedor:</label>
				    <input type="text" class="form-control" name="fornecedor" placeholder="Digite o nome do fornecedor" autocomplete="off" required="">
				</div>
